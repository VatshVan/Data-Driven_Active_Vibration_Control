...
from model import SpatialMPCOrchestrator
...
class SpatialMPCNode(Node):
    def __init__(self):
        ...
        self.pub_f1 = self.create_publisher(Float64, '/actuator_fl_controller/command', 10)
        self.pub_f2 = self.create_publisher(Float64, '/actuator_fr_controller/command', 10)
        self.pub_f3 = self.create_publisher(Float64, '/actuator_rl_controller/command', 10)
        self.pub_f4 = self.create_publisher(Float64, '/actuator_rr_controller/command', 10)
    ...
    def control_loop(self):
        ...
        msg1, msg2, msg3, msg4 = Float64(), Float64(), Float64(), Float64()
        msg1.data = float(u_opt[0])
        msg2.data = float(u_opt[1])
        msg3.data = float(u_opt[2])
        msg4.data = float(u_opt[3])

        self.pub_f1.publish(msg1)
        self.pub_f2.publish(msg2)
        self.pub_f3.publish(msg3)
        self.pub_f4.publish(msg4)
